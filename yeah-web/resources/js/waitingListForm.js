      ...
      success: function(responseData, textStatus, jqXHR) {
        if (responseData == 1) {
          Swal.fire({
            ...
            title: "Completed",
            text:
              "Thanks for expressing interest in Yeah, we are excited to create a product for you.",
            footer:
          ...
          Swal.fire({
            ...
            title: "Error",
            text:
              "Sorry, an error occurred. Kindly refresh your browser and resubmit the form.",
            footer:
              '<a href="mailto:yeah@theyeah.io?Subject=Question" target="_top">Have questions?</a>'
          });
